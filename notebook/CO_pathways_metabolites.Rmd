...
rownames(metabolites) <- c("SWT0", "SWT1", "SWT2", "SWT3", "SWT5")
head(pathways)
head(metabolites)
```
...
sign_path <- read_excel("/Users/micheladellalma/Library/CloudStorage/OneDrive-UniversitàdegliStudidiMilano/michela_0/Savorgnano/8_Corr_Pathways_Metabolites/unique_pathways.xlsx")
...
t_pathways$group <- c("SWT0", "SWT0", "SWT0", "SWT1", "SWT1", "SWT1", "SWT2", "SWT2", "SWT2", "SWT3", "SWT3", "SWT3", "SWT5", "SWT5", "SWT5")
head(t_pathways)
